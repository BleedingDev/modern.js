...
const publicEdgeExports = [
  {
    ...
    builtEntries: [
      '../../server/bff-effect/dist/esm/effect/edge.mjs',
  ...
  {
    allowGuardedAsyncHooksProbe: true,
    builtEntries: ['../../server/bff-effect/dist/esm/effect/edge.mjs'],
    forbiddenPackageCones: [],
  ...
  },
  {
    ...
    builtEntries: ['dist/esm/hono/index.mjs'],
    forbiddenPackageCones: [
...
describe('built edge package surfaces', () => {
  test.each(
    publicEdgeExports,
  )('bundles $label through published exports without Node evaluators', async ({
