 ...
 */
export const TANSTACK_ROUTER_VERSION = '1.170.33';
export const TANSTACK_ROUTER_CORE_VERSION = '1.171.28';
export const TANSTACK_HISTORY_VERSION = '1.162.2';
export const MODULE_FEDERATION_VERSION = '2.9.0';
export const ZEPHYR_RSPACK_PLUGIN_VERSION = '1.2.4';
export const ZEPHYR_AGENT_VERSION = '1.2.4';
...
export const EFFECT_TSGO_VERSION = '0.41.0';
export const MSGPACKR_VERSION = '2.1.0';
export const ZOD_VERSION = '4.5.4';
...
export const OXFMT_VERSION = '0.66.0';
export const ULTRACITE_VERSION = '7.11.0';
...
export const CLOUDFLARE_WORKERS_TYPES_VERSION = '5.20260906.1';
...
export const TYPES_NODE_VERSION = '^26.4.1';
export const TYPES_REACT_VERSION = '^19.2.18';
export const TYPES_REACT_DOM_VERSION = '^19.2.7';
