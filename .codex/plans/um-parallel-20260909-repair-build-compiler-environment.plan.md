---
name: um-parallel-20260909-repair-build-compiler-environment
...
todos:
  - id: repair-build-compiler-environment-implement
    ...
    status: pending
  - id: repair-build-compiler-environment-verify
    ...
    status: pending
  - id: repair-build-compiler-environment-handoff
...
# Repair: Compiler environment, native build options and precompression

## Execution Notes

Tracking: `modernjs-cdhz.29.50`. Mode: **write-capable**. Read [the parallel program](um-parallel-20260909-overview.md) and [the unchanged acceptance contract](um-zero-20260909-overview.md). This is a deferred execution plan; creating it does not perform its tasks.
...
Owner: `repair-build-compiler-environment`. Completion updates this plan and its exact br issue only after evidence is reviewed. Never mark a task complete because it is queued, drafted, or blocked.

Dependencies: [audit-build-compiler-environment](um-parallel-20260909-audit-build-compiler-environment.plan.md), [gate-shared-service](um-parallel-20260909-gate-shared-service.plan.md)
