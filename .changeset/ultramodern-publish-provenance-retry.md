...
Generated UltraModern workspaces now carry a structured validation
contract and an authenticated release-cohort projection derived from that exact
accepted manifest. Strict cohort installation fails closed on unsafe registries, redirects,
