...
Derive fresh, add-vertical and migrated workspace scripts from one artifact projection. Preserve authored shell files, package script segments, unknown configuration fields and compact default ports while deriving generated development URLs from live port overlays.
